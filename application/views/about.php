    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="<?php echo base_url()?>index.php/seminar/about">About</a></li>
...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        <a href="#" class="btn azm-social azm-size-64 azm-circle azm-long-shadow azm-github"><i class="fa fa-envelope"></i></a>
